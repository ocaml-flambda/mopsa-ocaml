...
DEFAULT_FILENAME = "data/chaos.ppm"
...
def main(thickness, width, height, iterations, filename, rng_seed):
    splines = [
        Spline([
...
if __name__ == "__main__":
        main(DEFAULT_THICKNESS, DEFAULT_WIDTH, DEFAULT_HEIGHT, DEFAULT_ITERATIONS, DEFAULT_FILENAME, DEFAULT_RNG_SEED)
