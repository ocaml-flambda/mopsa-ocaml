from typing import (
    Any, Callable, Dict, Iterable, List, IO, Optional,
...
class _ActionsContainer:
    ...
    def __init__(self, description: Optional[str], prefix_chars: str,
                 argument_default: Optional[str], conflict_handler: str) -> None: ...
...
class HelpFormatter:
    ...
    def add_usage(self, usage: str, actions: Iterable[Action], groups: Iterable[_ArgumentGroup], prefix: Optional[str] = ...) -> None: ...
    def add_argument(self, action: Action) -> None: ...
    def add_arguments(self, actions: Iterable[Action]) -> None: ...
    def format_help(self) -> str: ...
    def _join_parts(self, part_strings: Iterable[str]) -> str: ...
    def _format_usage(self, usage: str, actions: Iterable[Action], groups: Iterable[_ArgumentGroup], prefix: Optional[str]) -> str: ...
...
class RawstrHelpFormatter(HelpFormatter): ...
...
class Namespace(_AttributeHolder):
    ...
    def __getattribute__(self, name: str) -> Any: ... # cheating was getattr
...
class _ArgumentGroup(_ActionsContainer):
    ...
    def __init__(self, container: _ActionsContainer,
                 title: Optional[str] = ...,
                 description: Optional[str] = ..., **kwargs: Any) -> None: ...
