...
def format(format: str, val: Union[float, Decimal], grouping: bool = ...,
           monetary: bool = ...) -> str: ...
# if sys.version_info >= (3, 7):
def formatstring(format: str, val: Any,
                 grouping: bool = ..., monetary: bool = ...) -> str: ...
# else:
#     def formatstring(format: str, val: Any,
#                       grouping: bool = ...) -> str: ...
...
# conflicting with usual str function
# def str(float: float) -> str: ...
