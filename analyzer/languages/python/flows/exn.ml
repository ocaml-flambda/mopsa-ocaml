  ...
  struct
    ...
    let () =
      register_domain_option name {
        ...
        spec = String (ArgExt.set_string_list_lifter opt_unprecise_exn, ArgExt.empty);
        default = "";
      }
         ...
         bind (fun case flow ->
             ...
             assume
               ...
               ~fthen:(fun true_flow ->
                   ...
                   let exc_str, exc_message = ask_and_reduce man.ask (Python_types.Structural_types.Q_exn_string_query exp) true_flow in
                   debug "ok@\n";
                   let tk =
