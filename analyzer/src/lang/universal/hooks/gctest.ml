...
struct
  ...
  let on_finish man flow =
    let alladdr = man.ask (mk_query Heap.Recency.Q_allocated_addresses) flow in
    let reachaddr = Heap.Recency.Pool.elements @@ man.ask (mk_query Heap.Recency.Q_alive_addresses_aspset) flow in
