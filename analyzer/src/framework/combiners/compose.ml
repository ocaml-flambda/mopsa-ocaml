...
struct
  ...
  let exec_interface = Core.Sig.Interface.concat S1.exec_interface S2.exec_interface

  let eval_interface = Core.Sig.Interface.concat S1.eval_interface S2.eval_interface
