...
struct
  ...
  let id = I_binary(Compose,T1.id,T2.id)

  let name = T1.name ^ " o " ^ T2.name
  ...
  let subset man sman ctx ((a1,a2),s) ((a1',a2'),s') =
    let b1, (a2,s), (a2',s') = T1.subset (fst_pair_man man) (fst_pair_sman man sman) ctx (a1,(a2,s)) (a1',(a2',s')) in
    let b2, s, s' = T2.subset (snd_pair_man man) sman ctx (a2,s) (a2',s') in
    b1 && b2, s, s'

  let join man sman ctx ((a1,a2),s) ((a1',a2'),s') =
    let aa1, (a2,s), (a2',s') = T1.join (fst_pair_man man) (fst_pair_sman man sman) ctx (a1,(a2,s)) (a1',(a2',s')) in
    let aa2, s, s' = T2.join (snd_pair_man man) sman ctx (a2,s) (a2',s') in
    (aa1,aa2), s, s'

  let meet man sman ctx ((a1,a2),s) ((a1',a2'),s') =
    let aa1, (a2,s), (a2',s') = T1.meet (fst_pair_man man) (fst_pair_sman man sman) ctx (a1,(a2,s)) (a1',(a2',s')) in
    let aa2, s, s' = T2.meet (snd_pair_man man) sman ctx (a2,s) (a2',s') in
    (aa1,aa2), s, s'

  let widen man sman ctx ((a1,a2),s) ((a1',a2'),s') =
    let aa1, (a2,s), (a2',s'), stable1 = T1.widen (fst_pair_man man) (fst_pair_sman man sman) ctx (a1,(a2,s)) (a1',(a2',s')) in
